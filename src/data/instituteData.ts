...
export const MOCK_CERTIFICATES: Record<string, StudentCertificate> = {
  'ATI/2025/1042': {
    ...
    enrollmentNo: 'ATI/2025/1042',
    studentName: 'Akash D. Patil',
    studentDob: '14-05-2003',
  ...
  'ATI-101': {
    regNumber: 'ATI-101',
    enrollmentNo: 'ATI-101',
    studentName: 'Ganesh V. Chaudhari',
    studentDob: '19-01-2003',
    instituteName: 'Abhinav Technical Institute, Jalgaon',
    instituteCenter: 'Abhinav Technical Institute, Mansing Market, Jalgaon',
    courseName: 'Industrial Welding & Fabrication (Welder)',
    resultStatus: 'First Class',
    grade: 'A',
    totalMarks: '862/1000 (86.2%)',
    percentage: '86.2%',
    duration: '1 Year',
    examYear: 'August 2025',
